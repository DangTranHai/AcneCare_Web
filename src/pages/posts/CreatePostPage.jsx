  ...
  return (
    <div className="create-post" data-name="Tạo bài viết" data-node-id="28:9">
      ...
      <main className="create-post__main">
        <form id={FORM_ID} className="create-post__form" onSubmit={handleSubmit} noValidate>
          {submitError ? (
          ...
          <div className="create-post__title-card" data-name="Component 6" data-node-id="20:72">
            <label className="create-post__title-label" htmlFor={titleId} data-node-id="20:71">
          ...
          <div className="create-post__body-card" data-name="Component 8" data-node-id="20:74">
            <div className="create-post__divider" aria-hidden data-node-id="20:28">
            ...
            >
              ...
              {body.trim() ? (
                <span className="create-post__word-count"> ({wordCount}/1000)</span>
              ) : null}
            </p>
          </div>
        </form>
